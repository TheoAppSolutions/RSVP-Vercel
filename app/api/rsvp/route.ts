...
export async function POST(req: NextRequest) {
  try {
    ...
    const { name, email, attending, guests } = data;
    ...
    // Replace this with a real database/sheet write.
    console.log("New RSVP:", { name, email, attending, guests, receivedAt: new Date().toISOString() });
