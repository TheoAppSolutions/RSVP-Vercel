...
export const STYLE_1: RSVPTheme = {
  ...
  input:
    "w-full rounded-md border border-garden-300/60 bg-white px-4 py-3 text-garden-900 placeholder:text-garden-400 outline-none focus:border-garden-500 transition-colors",
  fieldset: "space-y-2",
  radioWrap: "flex gap-3",
  radioActive:
    "flex-1 rounded-md border border-garden-500 bg-garden-500 px-4 py-3 text-sm font-jost uppercase tracking-wide text-garden-50",
  radioInactive:
    "flex-1 rounded-md border border-garden-300/60 bg-white px-4 py-3 text-sm font-jost uppercase tracking-wide text-garden-600 hover:border-garden-500/60",
  button:
    "rounded-md bg-garden-500 py-3.5 font-jost text-sm uppercase tracking-[0.2em] text-garden-50 font-semibold hover:bg-garden-600 transition-colors",
...
export const STYLE_2: RSVPTheme = {
  ...
  input:
    "w-full border-0 border-b border-garden-300 bg-transparent px-1 py-3 text-center font-garamond text-lg text-garden-900 placeholder:text-garden-400 outline-none focus:border-garden-500 transition-colors",
  fieldset: "space-y-3",
  radioWrap: "flex gap-3",
  radioActive:
    "flex-1 border border-garden-500 bg-garden-500/10 px-4 py-3 text-sm font-jost tracking-wide text-garden-800",
  radioInactive:
    "flex-1 border border-garden-300 px-4 py-3 text-sm font-jost tracking-wide text-garden-500 hover:border-garden-500/50",
  button:
    "border border-garden-800 py-3.5 font-jost text-xs uppercase tracking-[0.25em] text-garden-800 hover:bg-garden-800 hover:text-garden-50 transition-colors",
...
export const STYLE_3: RSVPTheme = {
  ...
  button:
    "bg-garden-800 py-4 font-fraunces text-2xl italic tracking-wide text-white hover:bg-garden-900 transition-colors",
